...
export function configureCommand(program) {
  program
    .command('configure')
    .description('Configure your DDEX Distro platform settings')
    .action(async () => {
      try {
        ...
        console.log(chalk.cyan('⚙️  Configuring DDEX Distro\n'));
        ...
        const configPath = path.join(process.cwd(), 'ddex-distro.config.json');
        ...
        console.log('Configuration file: ' + chalk.cyan('ddex-distro.config.json'));
